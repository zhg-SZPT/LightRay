#-----------------------------
#Divide the dataset, train:val:test = 8：1：1
#-----------------------------
...
#   Annotation_mode = 1 means to get the txt in Xraydevkit/Xray2021/ImageSets
#   Annotation_mode = 2 means to obtain train.txt and val.txt for training
#--------------------------------------------------------------------------------------------------------------------------------#
annotation_mode     = 0
...
train_percent       = 0.9
#----------------------------------------------------------
#   Point to the folder where the Xray dataset is located
#----------------------------------------------------------
