...
from util.utils import (cvtColor, get_anchors, get_classes, preprocess_input,
                        resize_image)
from util.utils_bbox import DecodeBox
...
class YOLO(object):
    ...
    def __init__(self, **kwargs):
        ...
        #---------------------------------------------------#
        #   Get the number of classes and  priori boxes
        #---------------------------------------------------#
    ...
    def detect_image(self, image):
        ...
        with torch.no_grad():
            ...
            #   Stack prediction boxes and then perform non-maximal suppression.
