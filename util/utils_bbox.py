...
class DecodeBox():
    ...
    def decode_box(self, inputs):
        ...
        for i, input in enumerate(inputs):
            ...
            #----------------------------------------------------------#
            #   利用预测结果对先验框进行调整,调整先验框的中心，从先验框中心向右下角偏移,再调整先验框的宽高。
            #----------------------------------------------------------#
    ...
    def yolo_correct_boxes(self, box_xy, box_wh, input_shape, image_shape, letterbox_image):
        ...
        if letterbox_image:
            ...
            new_shape = np.round(image_shape * np.min(input_shape/image_shape))  # 宽高缩放
